...
WebUI.setText(findTestObject('ID-Mapping/Penyedia/Tambah_Penyedia/Input_NPWP'), '1627893746150923')
...
WebUI.waitForElementPresent(findTestObject('ID-Mapping/Penyedia/Tambah_Penyedia/Button_SimpanDraft'), 0)

WebUI.click(findTestObject('ID-Mapping/Penyedia/Tambah_Penyedia/Button_SimpanDraft'))
