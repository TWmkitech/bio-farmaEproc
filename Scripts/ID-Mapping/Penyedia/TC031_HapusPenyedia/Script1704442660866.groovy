...
WebUI.waitForElementPresent(findTestObject('ID-Mapping/Penyedia/Hapus_Penyedia/Button_Delete'), 0)

WebUI.click(findTestObject('ID-Mapping/Penyedia/Hapus_Penyedia/Button_Delete'))

WebUI.waitForElementPresent(findTestObject('ID-Mapping/Penyedia/Hapus_Penyedia/Button_OK'), 0)

WebUI.click(findTestObject('ID-Mapping/Penyedia/Hapus_Penyedia/Button_OK'))
