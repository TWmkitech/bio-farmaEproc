...
TestObject targetElement = findTestObject('Object Repository/ID-Mapping/Origin/Detail_Origin/Button_Detail')

WebUI.sendKeys(targetElement, Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('ID-Mapping/Origin/Detail_Origin/Button_Detail'), 0)

WebUI.click(findTestObject('ID-Mapping/Origin/Detail_Origin/Button_Detail'))
