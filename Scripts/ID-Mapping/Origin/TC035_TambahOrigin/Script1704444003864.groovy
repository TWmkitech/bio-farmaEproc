...
WebUI.waitForElementPresent(findTestObject('ID-Mapping/Origin/Tambah_Origin/Button_Kirim'), 0)

WebUI.click(findTestObject('ID-Mapping/Origin/Tambah_Origin/Button_Kirim'))
