...
TestObject targetElement = findTestObject('Object Repository/ID-Mapping/Material/Detail_KodeMaterial/Button_Detail')

WebUI.sendKeys(targetElement, Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('ID-Mapping/Material/Detail_KodeMaterial/Button_Detail'), 0)

WebUI.click(findTestObject('ID-Mapping/Material/Detail_KodeMaterial/Button_Detail'))
