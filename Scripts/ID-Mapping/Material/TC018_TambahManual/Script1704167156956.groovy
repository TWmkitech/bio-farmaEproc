...
WebUI.setText(findTestObject('ID-Mapping/Material/tambahManual/Input_UOM'), 'UOM-Test')
...
WebUI.click(findTestObject('ID-Mapping/Material/tambahManual/Button_Kirim'))
