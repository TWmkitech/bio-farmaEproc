...
WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap01_PendaftaranDanResponMinat/Internal/Selectbox_Date_PengTenderSeleksiTerbatas_TS_Hour_try'), 
    '1')

WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap01_PendaftaranDanResponMinat/Internal/Selectbox_Date_PengTenderSeleksiTerbatas_TS_Minute_try'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap01_PendaftaranDanResponMinat/Internal/Selectbox_Date_PengTenderSeleksiTerbatas_TS_Minute_try'), 
    '01')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap01_PendaftaranDanResponMinat/Internal/Selectbox_Date_PengTenderSeleksiTerbatas_TS_AMPM_Try'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap01_PendaftaranDanResponMinat/Internal/Selectbox_Date_PengTenderSeleksiTerbatas_TS_AMPM_Try'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap01_PendaftaranDanResponMinat/Internal/Selectbox_Date_PengTenderSeleksiTerbatas_TS_AMPM_Try'), 
...
String get = WebUI.getText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap01_PendaftaranDanResponMinat/Internal/Selectbox_Date_PengTenderSeleksiTerbatas_TS_AMPM_Try'))
