...
WebUI.scrollToElement(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/3_LihatEvalHarga/button_Kembali'), 
    5)

WebUI.delay(5)

WebUI.scrollToElement(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/2_EvaluasiHargaDariPG/button_Upload Dokumen'), 
    5)

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/3_LihatEvalHarga/Lihat_Vendor2'))
