...
WebUI.callTestCase(findTestCase('000_Custom/Precondition/ParameterizedTestObject/TransactionManagement/Internal/1_UbahJadwal/Select_Date10_EvaluasiHarga'), 
    [('index') : 20], FailureHandling.STOP_ON_FAILURE)

/*
WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHarga_Hour'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHarga_Hour'), 
    '1')

WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHarga_Minute'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHarga_Minute'), 
    '11')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHarga_AMPM'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHarga_AMPM'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHarga_AMPM'), 
...
String get = WebUI.getText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHarga_AMPM'))
