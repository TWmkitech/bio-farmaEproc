...
WebUI.callTestCase(findTestCase('000_Custom/Precondition/ParameterizedTestObject/TransactionManagement/Internal/1_UbahJadwal/SelectBox_Date_Column'), 
    [('index') : 29], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('000_Custom/Precondition/ParameterizedTestObject/TransactionManagement/Internal/1_UbahJadwal/Select_Date10_EvaluasiHarga_Selesai'), 
    [('index') : 20], FailureHandling.STOP_ON_FAILURE)

/*
WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHargaSelesai_Hour'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHargaSelesai_Hour'), 
    '1')

WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHargaSelesai_Minute'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHargaSelesai_Minute'), 
    '27')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHargaSelesai_AMPM'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHargaSelesai_AMPM'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHargaSelesai_AMPM'), 
...
String get = WebUI.getText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap07_EvaluasiHarga/Internal/1_UbahJadwal/Date10_EvaluasiHargaSelesai_AMPM'))
