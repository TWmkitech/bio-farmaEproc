...
WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap04_EvaluasiAdministrasiTeknis/Internal/4_KlarifikasiEvaluasiPenawaranPenyedia/Icon_PenilianEvaluasi2'))
...
WebUI.setText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap04_EvaluasiAdministrasiTeknis/Internal/4_KlarifikasiEvaluasiPenawaranPenyedia/Textbox_BuatPertanyaan'), 
    'Apakah Ini Pertanyaan ke Vendor2?')
