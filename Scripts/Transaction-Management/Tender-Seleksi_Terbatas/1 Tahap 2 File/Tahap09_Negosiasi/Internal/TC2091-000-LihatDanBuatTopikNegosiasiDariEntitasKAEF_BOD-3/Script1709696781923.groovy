...
WebUI.callTestCase(findTestCase('000_Custom/Precondition/Login/TransactionManagement/Paket1/0_User_PG/PGEntitas_KAEF_BOD-3'), 
...
WebUI.setText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap09_Negosiasi/Internal/3_BalasTopikdariEntitas/Textbox_BuatPertanyaan'), 
    'Buat Balasan Topik Dari Entitas KAEF BOD-3 Ke PG Holding')
