...
WebUI.callTestCase(findTestCase('000_Custom/Precondition/ParameterizedTestObject/TransactionManagement/Internal/1_UbahJadwal/Select_Date9_PembukaanPenawaranHarga_Selesai'), 
    [('index') : 20], FailureHandling.STOP_ON_FAILURE)

/*
WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap06_PembukaanPenawaranHarga/Internal/1_UbahJadwal/Date9_PembukaanPenawaranHargaSelesai_Hour'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap06_PembukaanPenawaranHarga/Internal/1_UbahJadwal/Date9_PembukaanPenawaranHargaSelesai_Hour'), 
    '1')

WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap06_PembukaanPenawaranHarga/Internal/1_UbahJadwal/Date9_PembukaanPenawaranHargaSelesai_Minute'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap06_PembukaanPenawaranHarga/Internal/1_UbahJadwal/Date9_PembukaanPenawaranHargaSelesai_Minute'), 
    '03')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap06_PembukaanPenawaranHarga/Internal/1_UbahJadwal/Date9_PembukaanPenawaranHargaSelesai_AMPM'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap06_PembukaanPenawaranHarga/Internal/1_UbahJadwal/Date9_PembukaanPenawaranHargaSelesai_AMPM'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap06_PembukaanPenawaranHarga/Internal/1_UbahJadwal/Date9_PembukaanPenawaranHargaSelesai_AMPM'), 
...
String get = WebUI.getText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap06_PembukaanPenawaranHarga/Internal/1_UbahJadwal/Date9_PembukaanPenawaranHargaSelesai_AMPM'))
