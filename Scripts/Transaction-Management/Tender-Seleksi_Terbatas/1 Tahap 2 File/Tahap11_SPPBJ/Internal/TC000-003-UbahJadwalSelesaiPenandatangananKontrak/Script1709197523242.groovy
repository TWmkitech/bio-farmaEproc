...
WebUI.callTestCase(findTestCase('000_Custom/Precondition/ParameterizedTestObject/TransactionManagement/Internal/1_UbahJadwal/Select_Date16_PenandatangananKontrakSelesai'), 
    [('index') : 5], FailureHandling.STOP_ON_FAILURE)

WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap11_SPPBJ/Internal/1_UbahJadwal/Date16_PenandatangananKontrakSelesai_Hour'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap11_SPPBJ/Internal/1_UbahJadwal/Date16_PenandatangananKontrakSelesai_Hour'), 
    '6')

WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap11_SPPBJ/Internal/1_UbahJadwal/Date16_PenandatangananKontrakSelesai_Minute'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap11_SPPBJ/Internal/1_UbahJadwal/Date16_PenandatangananKontrakSelesai_Minute'), 
    '11')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap11_SPPBJ/Internal/1_UbahJadwal/Date16_PenandatangananKontrakSelesai_AMPM'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap11_SPPBJ/Internal/1_UbahJadwal/Date16_PenandatangananKontrakSelesai_AMPM'), 
