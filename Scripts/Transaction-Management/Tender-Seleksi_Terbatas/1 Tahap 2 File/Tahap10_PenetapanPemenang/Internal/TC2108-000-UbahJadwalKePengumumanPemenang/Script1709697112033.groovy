...
WebUI.callTestCase(findTestCase('000_Custom/Precondition/ParameterizedTestObject/TransactionManagement/Internal/1_UbahJadwal/SelectBox_Date_Column'), 
    [('index') : 40], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('000_Custom/Precondition/ParameterizedTestObject/TransactionManagement/Internal/1_UbahJadwal/Select_Date14_PengumumanPemenang'), 
    [('index') : 21], FailureHandling.STOP_ON_FAILURE)

/*
WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap10_PenetapanPemenang/Internal/1_UbahJadwal/Date14_PengumumanPemenang_Hour'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap10_PenetapanPemenang/Internal/1_UbahJadwal/Date14_PengumumanPemenang_Hour'), 
    '1')

WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap10_PenetapanPemenang/Internal/1_UbahJadwal/Date14_PengumumanPemenang_Minute'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap10_PenetapanPemenang/Internal/1_UbahJadwal/Date14_PengumumanPemenang_Minute'), 
    '25')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap10_PenetapanPemenang/Internal/1_UbahJadwal/Date14_PengumumanPemenang_AMPM'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap10_PenetapanPemenang/Internal/1_UbahJadwal/Date14_PengumumanPemenang_AMPM'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap10_PenetapanPemenang/Internal/1_UbahJadwal/Date14_PengumumanPemenang_AMPM'), 
...
String get = WebUI.getText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap10_PenetapanPemenang/Internal/1_UbahJadwal/Date14_PengumumanPemenang_AMPM'))
