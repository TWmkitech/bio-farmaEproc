...
WebUI.callTestCase(findTestCase('000_Custom/Precondition/ParameterizedTestObject/TransactionManagement/Internal/1_UbahJadwal/Select_Date11_ApprovalEvalPenawaran'), 
    [('index') : 20], FailureHandling.STOP_ON_FAILURE)

/*
WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap08_Approval Evaluasi Penawaran/Internal/1_UbahJadwal/Date11_ApprovalEvalPenawaran_Hour'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap08_Approval Evaluasi Penawaran/Internal/1_UbahJadwal/Date11_ApprovalEvalPenawaran_Hour'), 
    '1')

WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap08_Approval Evaluasi Penawaran/Internal/1_UbahJadwal/Date11_ApprovalEvalPenawaran_Minute'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap08_Approval Evaluasi Penawaran/Internal/1_UbahJadwal/Date11_ApprovalEvalPenawaran_Minute'), 
    '34')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap08_Approval Evaluasi Penawaran/Internal/1_UbahJadwal/Date11_ApprovalEvalPenawaran_AMPM'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap08_Approval Evaluasi Penawaran/Internal/1_UbahJadwal/Date11_ApprovalEvalPenawaran_AMPM'))

WebUI.sendKeys(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap08_Approval Evaluasi Penawaran/Internal/1_UbahJadwal/Date11_ApprovalEvalPenawaran_AMPM'), 
...
String get = WebUI.getText(findTestObject('TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap08_Approval Evaluasi Penawaran/Internal/1_UbahJadwal/Date11_ApprovalEvalPenawaran_AMPM'))
