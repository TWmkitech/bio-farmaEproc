...
WebUI.callTestCase(findTestCase('Transaction-Management/Tender-Seleksi_Umum/login/PGEntitasKAEF-BOD3'), [:], 
...
WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/SPPBJ/SetujuSPJPKAEFBOD-3'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/SPPBJ/PersetujuanSPJPKAEFBOD-3'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/SPPBJ/a_ok_persetujuanKAEFBOD-3'))
