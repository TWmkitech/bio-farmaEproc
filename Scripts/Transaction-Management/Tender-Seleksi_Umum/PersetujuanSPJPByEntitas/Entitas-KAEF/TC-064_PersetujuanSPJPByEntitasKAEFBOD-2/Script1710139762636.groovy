...
WebUI.callTestCase(findTestCase('Transaction-Management/Tender-Seleksi_Umum/login/PGEntitasKAEF-BOD2'), [:], 
...
WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/SPPBJ/SetujuSPJPKAEFBOD-2'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/SPPBJ/PersetujuanSPJPKAEFBOD-2'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/SPPBJ/a_ok_persetujuanKAEFBOD-2'))
