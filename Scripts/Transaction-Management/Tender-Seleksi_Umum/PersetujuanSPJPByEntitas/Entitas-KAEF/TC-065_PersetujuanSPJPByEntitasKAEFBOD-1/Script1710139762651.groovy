...
WebUI.callTestCase(findTestCase('Transaction-Management/Tender-Seleksi_Umum/login/PGEntitasKAEF-BOD1'), [:], 
...
WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/SPPBJ/SetujuSPJPKAEFBOD-1'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/SPPBJ/PersetujuanSPJPKAEFBOD-1'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/SPPBJ/a_ok_persetujuanKAEFBOD-1'))
