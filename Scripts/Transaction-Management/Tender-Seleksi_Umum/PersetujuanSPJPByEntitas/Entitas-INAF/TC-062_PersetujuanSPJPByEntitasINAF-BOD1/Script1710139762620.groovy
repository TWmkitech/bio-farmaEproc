...
WebUI.callTestCase(findTestCase('Transaction-Management/Tender-Seleksi_Umum/login/PGEntitasINAF-BOD1'), [:], 
...
WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/SPPBJ/PersetujuanSPJPINAFBOD-1'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/SPPBJ/a_ok_persetujuanINAFBOD-1'))
