...
WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/019_Review_Berita_Acara/tombol_Persetujuan_Pembukaan_Penawaran'))

WebUI.setText(findTestObject('TransactionManagement/Seleksi-Umum/019_Review_Berita_Acara/input_Catatan'), 'Sudah di review, tidak ada catatan. Silakan lanjutkan')

WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/019_Review_Berita_Acara/pilih_Setuju'))

WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/019_Review_Berita_Acara/tombol_Kirim'))

WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/019_Review_Berita_Acara/konfirmasi_OK'))
