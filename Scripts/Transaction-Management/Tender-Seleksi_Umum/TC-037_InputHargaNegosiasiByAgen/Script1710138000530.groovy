...
WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/input_Spesifikasi1'))

WebUI.setText(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/input_Spesifikasi1'), '98000000')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/button_KirimNegosiasi_Agen'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/button_konfirmasi_negosiasi'))

not_run: WebUI.delay(8)

not_run: WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/button_Hasil Evaluasi Dokumen Admin  Teknis'))

not_run: WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/button_TutupHasilEvaluasiAdmin'))
