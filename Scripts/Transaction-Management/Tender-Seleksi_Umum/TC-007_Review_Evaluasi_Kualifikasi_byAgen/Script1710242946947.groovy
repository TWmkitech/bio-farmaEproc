...
WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/007_Review_Evaluasi_Kualifikasi/button_Review'))

WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/007_Review_Evaluasi_Kualifikasi/informasi_Ditampilkan'))

WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/007_Review_Evaluasi_Kualifikasi/klik_Setuju'))

WebUI.setText(findTestObject('TransactionManagement/Seleksi-Umum/007_Review_Evaluasi_Kualifikasi/isi_Catatan'), 'Proses review selesai, tidak ada catatan. Semua lengkap, lanjutkan')
