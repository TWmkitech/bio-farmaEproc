...
WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/026_Ajukan_Persetujuan_Hasil_Evaluasi_byAgen/transaction_Management'))

WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/026_Ajukan_Persetujuan_Hasil_Evaluasi_byAgen/tender_Seleksi_Umum'))
...
WebUI.setText(findTestObject('TransactionManagement/Seleksi-Umum/026_Ajukan_Persetujuan_Hasil_Evaluasi_byAgen/input_Dokumen'), 
    'Dokumen Hasil Evaluasi')

def projectDir = Config.getProjectDir()

// Ambil elemen field "Choose File"
TestObject uploadField = findTestObject('TransactionManagement/Seleksi-Umum/026_Ajukan_Persetujuan_Hasil_Evaluasi_byAgen/upload_Dokumen_Hasil_Evaluasi')
...
WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/026_Ajukan_Persetujuan_Hasil_Evaluasi_byAgen/tombol_Ajukan_Persetujuan_Evaluasi'))
