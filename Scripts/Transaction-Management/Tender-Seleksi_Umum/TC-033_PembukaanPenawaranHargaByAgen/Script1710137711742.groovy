...
WebUI.enhancedClick(findTestObject('TransactionManagement/Tender-Seleksi-umum/PembukaanPenawaranByAgen/span_Tahapan Pembukaan Penawaran Harga'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/PembukaanPenawaranByAgen/button_DokumenPenawaran'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/PembukaanPenawaranByAgen/button_Ya'))
