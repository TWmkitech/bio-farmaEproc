...
WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/006_Pengajuan_Persetujuan_Evaluasi/button_Ajukan_Persetujuan'))

WebUI.setText(findTestObject('TransactionManagement/Seleksi-Umum/006_Pengajuan_Persetujuan_Evaluasi/isi_Catatan'), 'Semua vendor melampirkan kualifikasi dengan lengkap')
