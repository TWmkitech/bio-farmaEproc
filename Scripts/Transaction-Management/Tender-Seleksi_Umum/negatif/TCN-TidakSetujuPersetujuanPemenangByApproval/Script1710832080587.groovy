...
WebUI.enhancedClick(findTestObject('TransactionManagement/Tender-Seleksi-umum/PenetapanPemenang/span_Tahapan  Penetapan Pemenang'))
...
WebUI.setText(findTestObject('TransactionManagement/Tender-Seleksi-umum/PenetapanPemenang/CatatanDisposisiApproval'), 'saya tidak setuju')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/PenetapanPemenang/TidakSetujuPenetapanPemenangByApproval'))

WebUI.setText(findTestObject('TransactionManagement/Tender-Seleksi-umum/PenetapanPemenang/AlasanPenolakan'), 'lakukan perbandingan kembali')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/PenetapanPemenang/button_KirimPemenang'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/PenetapanPemenang/a_ok_tidakSetuju'))
