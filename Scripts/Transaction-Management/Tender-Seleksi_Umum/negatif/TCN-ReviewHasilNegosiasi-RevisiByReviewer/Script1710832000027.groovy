...
WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/button_RevisiByReviewer'))

WebUI.setText(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/Catatan_ReviewHasilNegosiasi'), 'Terdapat masih ada kesalahan')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/button_Review  Approval hasil negosiasi'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/a_ok_revisiByReviewer'))
