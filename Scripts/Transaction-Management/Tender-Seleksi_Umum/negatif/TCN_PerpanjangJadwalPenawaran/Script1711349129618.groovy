...
WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/PemasukanPenawaran/button_PerpanjanganJadwal'))

WebUI.callTestCase(findTestCase('Transaction-Management/Tender-Seleksi_Umum/negatif/PerpanjangJadwal'), [('tahap') : 11], 
