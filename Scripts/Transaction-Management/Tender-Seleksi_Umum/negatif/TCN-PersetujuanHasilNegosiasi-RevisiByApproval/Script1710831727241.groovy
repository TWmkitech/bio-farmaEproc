...
WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/RevisiByApproval'))

WebUI.setText(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/catatan_ApprovalHasilNegosiasi'), 'revisi kembali bagian A')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/button_PersetujuanHasilNegosialByApproval'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Negosiasi/a_ok_revisiByApproval'))
