...
WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/simpanPersetujuanByReviewer'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/revisiEvaluasiHarga-Reviewer'))

WebUI.setText(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/catatanRevisiHarga-Reviewer'), 'periksa kembali')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/buttonReviewEvaluasiHarga-reviewer'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/a_ok_revisiReviwer'))
