...
WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/023_Klarifikasi_EvaluasiPenawaran_byAgen/klarifikasi_Evaluasi_Vendor1'))

WebUI.delay(2)

WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/023_Klarifikasi_EvaluasiPenawaran_byAgen/tombol_KirimTopik'))

WebUI.setText(findTestObject('TransactionManagement/Seleksi-Umum/023_Klarifikasi_EvaluasiPenawaran_byAgen/buat_Pertanyaan'), 
    'Lampirkan bukti keterlibatan atasnama Tania Salsa dalam pekerjaan sejenis')

def projectDir = Config.getProjectDir()

// Ambil elemen field "Choose File"
TestObject uploadField = findTestObject('TransactionManagement/Seleksi-Umum/023_Klarifikasi_EvaluasiPenawaran_byAgen/upload_File_Klarifikasi')
...
WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/023_Klarifikasi_EvaluasiPenawaran_byAgen/tombol_SimpanKirim'))
