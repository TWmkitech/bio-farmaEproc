...
WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Vendor/InputNegosiasiByPenyedia/lihat_riwayat_negosiasi'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Vendor/InputNegosiasiByPenyedia/TutupRiwayatNegosiasi'))
