...
WebUI.clearText(findTestObject('TransactionManagement/Tender-Seleksi-umum/Vendor/InputNegosiasiByPenyedia/input_Spesifikasi1'))

WebUI.setText(findTestObject('TransactionManagement/Tender-Seleksi-umum/Vendor/InputNegosiasiByPenyedia/input_Spesifikasi1'), 
    '99000000')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Vendor/InputNegosiasiByPenyedia/kirimHarga_Negosiasi'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Vendor/InputNegosiasiByPenyedia/konfirmasi_Ok_KirimNegosiasi'))
