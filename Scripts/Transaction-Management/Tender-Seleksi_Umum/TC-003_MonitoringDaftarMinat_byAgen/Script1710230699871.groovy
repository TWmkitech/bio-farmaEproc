...
WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/003-MonitoringDaftarMinat/proses_tender'))

WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/003-MonitoringDaftarMinat/tab_Pendaftaran_ResponMinat'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('TransactionManagement/Seleksi-Umum/003-MonitoringDaftarMinat/list_Daftar_ResponMinat'), 
    4)
