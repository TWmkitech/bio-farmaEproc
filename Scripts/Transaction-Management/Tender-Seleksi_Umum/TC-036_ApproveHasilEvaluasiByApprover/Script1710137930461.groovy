...
WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/button_SimpanPersetujuan_Approval'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/input_radiobutton_setuju_approval'))

WebUI.setText(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/textarea_CatatanApproval'), 'setuju dan lanjutkan')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/button_approval'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/konfirmasi_ok_approval'))
