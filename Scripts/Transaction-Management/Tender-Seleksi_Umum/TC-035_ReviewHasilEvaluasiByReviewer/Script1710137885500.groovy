...
WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/button_SimpanPersetujuan_Reviewer'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/input_Setuju'))

WebUI.setText(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/textarea_CatatanReviewer'), 'setuju dan lanjutkan')

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/button_ApprovalReviewer'))

WebUI.click(findTestObject('TransactionManagement/Tender-Seleksi-umum/Evaluasiharga/konfirmasi_ok_reviewer'))
