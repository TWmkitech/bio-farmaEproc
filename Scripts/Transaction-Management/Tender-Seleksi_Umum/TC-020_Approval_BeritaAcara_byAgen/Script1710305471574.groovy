...
WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/020_Approval_Berita_Acara/tombol_Persetujuan_Pembukaan_Penawaran'))

WebUI.setText(findTestObject('TransactionManagement/Seleksi-Umum/020_Approval_Berita_Acara/input_Catatan'), 'Berita acara disetujui, silakan lanjutkan prosesnya')

WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/020_Approval_Berita_Acara/pilih_Setuju'))

WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/020_Approval_Berita_Acara/tombol_Kirim'))

WebUI.click(findTestObject('TransactionManagement/Seleksi-Umum/020_Approval_Berita_Acara/konfirmasi_OK'))
