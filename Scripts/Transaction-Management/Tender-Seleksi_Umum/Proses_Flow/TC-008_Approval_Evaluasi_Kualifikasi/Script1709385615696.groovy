...
WebUI.setText(findTestObject('Transaction-Management/Seleksi-Umum/003-MonitoringDaftarMinat/input_Username_username'), 'bagas.s')
...
WebUI.click(findTestObject('Transaction-Management/Seleksi-Umum/008_Approval_Evaluasi_Kualifikasi/button_Review'))

WebUI.click(findTestObject('Transaction-Management/Seleksi-Umum/008_Approval_Evaluasi_Kualifikasi/informasi_Ditampilkan'))

WebUI.click(findTestObject('Transaction-Management/Seleksi-Umum/008_Approval_Evaluasi_Kualifikasi/klik_Setuju'))

WebUI.setText(findTestObject('Transaction-Management/Seleksi-Umum/008_Approval_Evaluasi_Kualifikasi/isi_Catatan'), 'Disetujui, lanjutkan')
