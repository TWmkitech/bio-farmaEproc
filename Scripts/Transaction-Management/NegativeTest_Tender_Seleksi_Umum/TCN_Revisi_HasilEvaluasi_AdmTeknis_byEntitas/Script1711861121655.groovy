...
WebUI.click(findTestObject('TransactionManagement/NegativeTest_Tender_Seleksi_Umum/Revisi_HasilEvaluasi_AdmTeknis_byEntitas/transaction_Management'))

WebUI.click(findTestObject('TransactionManagement/NegativeTest_Tender_Seleksi_Umum/Revisi_HasilEvaluasi_AdmTeknis_byEntitas/tender_SeleksiUmum'))
...
WebUI.click(findTestObject('TransactionManagement/NegativeTest_Tender_Seleksi_Umum/Revisi_HasilEvaluasi_AdmTeknis_byEntitas/ajukan_Persetujuan'))

WebUI.click(findTestObject('TransactionManagement/NegativeTest_Tender_Seleksi_Umum/Revisi_HasilEvaluasi_AdmTeknis_byEntitas/keputusan_Revisi'))

WebUI.setText(findTestObject('TransactionManagement/NegativeTest_Tender_Seleksi_Umum/Revisi_HasilEvaluasi_AdmTeknis_byEntitas/catatan_Revisi'), 
    'Periksa kembali')

WebUI.delay(3)

WebUI.click(findTestObject('TransactionManagement/NegativeTest_Tender_Seleksi_Umum/Revisi_HasilEvaluasi_AdmTeknis_byEntitas/tombol_SimpanKirim'))
