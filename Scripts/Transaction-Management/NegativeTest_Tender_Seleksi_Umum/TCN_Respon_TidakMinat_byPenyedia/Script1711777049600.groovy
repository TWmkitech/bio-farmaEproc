...
WebUI.click(findTestObject('TransactionManagement/NegativeTest_Tender_Seleksi_Umum/Respon_TidakMinat_byPenyedia/proses_Minat'))

WebUI.delay(5)

WebUI.click(findTestObject('TransactionManagement/NegativeTest_Tender_Seleksi_Umum/Respon_TidakMinat_byPenyedia/button_TidakMinat'))

WebUI.click(findTestObject('TransactionManagement/NegativeTest_Tender_Seleksi_Umum/Respon_TidakMinat_byPenyedia/konfirmasi_Kirim'))
