...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/text_CatatanRevisi'), 'REVISI SPJP by KFTD BOD-1')
...
WebUI.verifyMatch(user.contains('Approver (KFTD) | ').toString(), 'true', false, FailureHandling.OPTIONAL)
