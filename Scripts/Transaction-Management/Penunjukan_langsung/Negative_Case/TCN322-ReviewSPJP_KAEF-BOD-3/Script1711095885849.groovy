...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/text_CatatanRevisi'), 'REVISI SPJP by KAEF BOD-3')
...
WebUI.verifyMatch(user.contains('Reviewer 1 (KAEF) | ').toString(), 'true', false, FailureHandling.OPTIONAL)
