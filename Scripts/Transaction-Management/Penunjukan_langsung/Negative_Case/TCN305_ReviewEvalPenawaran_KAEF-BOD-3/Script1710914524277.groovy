...
WebUI.callTestCase(findTestCase('000_Custom/Precondition/Login/TransactionManagement/Paket2/PGEntitas_KAEF_BOD-3'), [:], 
...
String tugas = WebUI.getText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/General/row1_DaftarTugas'), 
    FailureHandling.OPTIONAL).contains('Permintaan Review & Approval Evaluasi Penawaran').toString()
...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap06/textarea_Catatan_form'), 'REVISI dari KAEF 03')
...
WebUI.verifyElementText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap06/verify_StatusEntitasBOD3'), 
