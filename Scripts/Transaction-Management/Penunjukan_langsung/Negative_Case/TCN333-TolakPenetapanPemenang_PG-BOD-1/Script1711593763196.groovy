...
String notif = WebUI.getText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/General/row1_Notifikasi'), 
    FailureHandling.OPTIONAL).contains('Permintaan Persetujuan Penetapan Pemenang').toString()
...
String alasan = 'Test Flow Penolakan'

WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap08/button_PersetujuanPenetapan'))

WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap08/text_NotesLampiran'), 'Penolakan Penetapan Pemenang by BOD 1')

WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap08/__Tolak/radio_Tolak'))

WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap08/__Tolak/text_AlasanTolak'), alasan)
...
// Verifikasi tender selesai
WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/General/Submodul_PenunjukanLangsung'))

WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/General/Tab_TenderSelesai'))

WebUI.delay(2)

WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/General/input_Searching02'), GlobalVariable.NoPP)

WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/General/Icon_ProsesEnd'))

WebUI.delay(5)

WebUI.verifyElementText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap08/__Tolak/verify_StatusProses'), 
    'Pengadaan Gagal')

WebUI.verifyElementText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap08/__Tolak/verify_AlasanTolak'), 
    alasan)

WebUI.verifyElementVisible(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap08/__Tolak/button_TindakLanjut'))
