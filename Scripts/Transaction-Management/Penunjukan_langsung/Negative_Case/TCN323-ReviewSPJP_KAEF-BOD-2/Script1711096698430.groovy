...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/text_CatatanRevisi'), 'REVISI SPJP by KAEF BOD-2')
...
WebUI.verifyMatch(user.contains('Reviewer 2 (KAEF) | ').toString(), 'true', false, FailureHandling.OPTIONAL)
