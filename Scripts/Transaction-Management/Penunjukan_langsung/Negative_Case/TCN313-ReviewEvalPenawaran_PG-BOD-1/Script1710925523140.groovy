...
String text = 'Permintaan Approval Evaluasi Penawaran Pada Paket Pekerjaan No PP : ' + GlobalVariable.NoPP
...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap06/textarea_Catatan_form'), 'REVISI dari PG BOD 01')
