...
WebUI.verifyElementText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap03/Revisi/row1_Notifikasi'), 
    'Permintaan Revisi Pembukaan Penawaran')

WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap03/Revisi/row1_Notifikasi'))
