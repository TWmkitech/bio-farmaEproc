...
String tugas = WebUI.getText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/General/row1_DaftarTugas'), 
    FailureHandling.OPTIONAL).contains('Permintaan Approval Evaluasi Penawaran').toString()
...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap06/textarea_Catatan_form'), 'REVISI dari KFTD 01')
