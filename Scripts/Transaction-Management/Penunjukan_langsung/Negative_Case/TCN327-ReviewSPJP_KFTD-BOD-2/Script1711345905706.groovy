...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/text_CatatanRevisi'), 'REVISI SPJP by KFTD BOD-2')
...
String user = WebUI.getText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/verify_h6_KAEF',
		[('row') : row])).contains('Reviewer 2 (KFTD) | ').toString()
