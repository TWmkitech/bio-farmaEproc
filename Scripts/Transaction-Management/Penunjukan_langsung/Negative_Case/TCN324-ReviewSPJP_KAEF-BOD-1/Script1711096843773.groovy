...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/text_CatatanRevisi'), 'REVISI SPJP by KAEF BOD-1')
...
WebUI.verifyMatch(user.contains('Approver (KAEF) | ').toString(), 'true', false, FailureHandling.OPTIONAL)
