...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/__Revisi/input_PersenJaminan_E1'), 
    '90')

WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/Field_SPJPTax_E1'), '12')
...
WebUI.verifyElementText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/verify_StatSPJP_E1'), 
    'Proses Revisi')

WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/__Revisi/button_SimpanE1'))
