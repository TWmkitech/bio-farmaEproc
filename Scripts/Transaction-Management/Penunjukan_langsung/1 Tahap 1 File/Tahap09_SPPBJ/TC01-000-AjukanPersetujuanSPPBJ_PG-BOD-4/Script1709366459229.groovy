...
WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/date_StartSPJP_KFTD'))

WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/Field_BatasSPJP_KFTD'))

WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/date_EndSPJP_KFTD'))

// Jaminan KAEF
WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/Field_TanggalSPJP_KAEF'))

WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/date_StartSPJP_KAEF'))

WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/Field_BatasSPJP_KAEF'))

WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/date_EndSPJP_KAEF'))
...
WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/date_SPPBJ'))
