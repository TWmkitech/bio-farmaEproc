...
WebUI.scrollToElement(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/verify_Setuju_KAEF', [('row') : 3]), 
...
if (user.contains('  Reviewer 2 (KAEF) | ')) {
