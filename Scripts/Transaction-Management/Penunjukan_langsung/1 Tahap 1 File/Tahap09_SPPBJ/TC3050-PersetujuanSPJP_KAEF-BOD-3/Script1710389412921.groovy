...
WebUI.scrollToElement(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/verify_Setuju_KAEF', [('row') : 2]), 
...
if (user.contains('  Reviewer 1 (KAEF) | ')) {
