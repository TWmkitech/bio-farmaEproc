...
WebUI.scrollToElement(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/verify_Setuju_PG', [('row') : 2]), 
    5, FailureHandling.OPTIONAL)

String user = WebUI.getText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/verify_h6_PG', [('row') : 2]))
...
if (user.contains('  Reviewer (HOLDING) | ')) {
