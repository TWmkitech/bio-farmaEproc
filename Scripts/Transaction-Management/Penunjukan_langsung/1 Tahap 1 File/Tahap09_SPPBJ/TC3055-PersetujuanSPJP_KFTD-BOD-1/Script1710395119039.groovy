...
WebUI.scrollToElement(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/verify_Setuju_KAEF', [('row') : 5]), 
...
if(user.contains('  Approver (KFTD) | ')) {
