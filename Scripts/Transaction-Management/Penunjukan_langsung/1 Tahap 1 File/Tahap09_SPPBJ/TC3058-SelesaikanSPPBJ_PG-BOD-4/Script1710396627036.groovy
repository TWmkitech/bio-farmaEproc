...
WebUI.scrollToElement(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/verify_StatusSPPBJ'), 5)

def status = WebUI.verifyElementText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap09/verify_StatusSPPBJ'), 
...
if (status.equals(true)) {
    WebUI.callTestCase(findTestCase('Transaction-Management/Penunjukan_langsung/1 Tahap 1 File/Paket02_UbahJadwal_woLogin'), 
        [('tahap') : 12], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyTextPresent('Proses Pengadaan Tahapan SPPBJ sudah habis!', false, FailureHandling.OPTIONAL)
