...
WebUI.callTestCase(findTestCase('000_Custom/Precondition/Login/TransactionManagement/Paket2/PGEntitas_KAEF_BOD-2'), [:], 
...
WebUI.click(findTestObject('TransactionManagement/Penunjukan-Langsung/Tahap06/Internal/icon_Proses_KAEF'))
...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan-Langsung/Tahap06/Internal/textarea_Catatan_form'), 'Setuju dari KAEF 02')
...
WebUI.verifyElementText(findTestObject('TransactionManagement/Penunjukan-Langsung/Tahap06/Internal/verify_StatusEntitasBOD2'), 
    'Setuju')
