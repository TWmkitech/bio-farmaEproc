...
WebUI.callTestCase(findTestCase('000_Custom/Precondition/Login/TransactionManagement/Paket2/PGEntitas_KFTD_BOD-1'), [:], 
...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan-Langsung/Tahap06/Internal/textarea_Catatan_form'), 'Setuju dari KFTD 01')
...
WebUI.verifyElementText(findTestObject('TransactionManagement/Penunjukan-Langsung/Tahap06/Internal/verify_StatApproval-E2-BOD1'), 
    'Setuju')
// Tambah status persetujuan BOD 3 : Proses Pengajuan
