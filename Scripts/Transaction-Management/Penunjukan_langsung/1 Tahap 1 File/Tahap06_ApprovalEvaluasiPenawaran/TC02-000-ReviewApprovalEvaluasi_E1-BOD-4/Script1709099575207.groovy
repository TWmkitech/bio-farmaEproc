...
WebUI.callTestCase(findTestCase('000_Custom/Precondition/Login/TransactionManagement/Paket2/PGEntitas_KAEF_BOD-4'), [:],
...
WebUI.click(findTestObject('TransactionManagement/Penunjukan-Langsung/Tahap06/Internal/icon_Proses_E'))
...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan-Langsung/Tahap06/Internal/textarea_Catatan_form'), 'Setuju dari KAEF 04')
...
WebUI.verifyElementText(findTestObject('TransactionManagement/Penunjukan-Langsung/Tahap06/Internal/verify_StatusEntitasBOD4'),
	'Setuju')