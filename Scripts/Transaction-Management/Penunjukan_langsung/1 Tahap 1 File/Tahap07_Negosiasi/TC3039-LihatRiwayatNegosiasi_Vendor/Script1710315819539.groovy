...
//WebUI.verifyElementText(findTestObject('TransactionManagement/Penunjukan_Langsung/Vendor/Tahap07/verify_Pengirim'), 'nama vendor')
String nego1a = WebUI.getText(findTestObject('TransactionManagement/Penunjukan_Langsung/Vendor/Tahap07/verify_Harga')).replace(
    'IDR ', '')
...
// Lihat Riwayat & Verifikasi Harga dan Pengirim
WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Vendor/Tahap07/button_RiwayatNegoE2'))

WebUI.delay(3)

String nego2a = WebUI.getText(findTestObject('TransactionManagement/Penunjukan_Langsung/Vendor/Tahap07/verify_Harga')).replace(
    'IDR ', '')
