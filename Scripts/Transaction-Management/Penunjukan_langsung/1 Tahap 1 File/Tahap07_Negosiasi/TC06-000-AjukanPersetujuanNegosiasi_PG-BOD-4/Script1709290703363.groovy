...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap07/text_NamaDokumenPendukung'), 'Dokumen Pendukung Test')

TestObject uploadFile = findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap07/btn_UploadFilePendukung')

def projectDir = Config.getProjectDir()

// Membentuk path lengkap file yang ingin diunggah
def filePath = projectDir + '/Document/Paket2/doc_test.docx'
...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap07/text_CatatanAjukanPersetujuan'), 
    'Ajukan Persetujuan Negosiasi by BOD 4')
