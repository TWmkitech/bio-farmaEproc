...
WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap07/text_CatatanKeputusanNego'), 'Vendor berhasil nego')
...
// Verifikasi status negosiasi :  Berhasil Negosiasi 
