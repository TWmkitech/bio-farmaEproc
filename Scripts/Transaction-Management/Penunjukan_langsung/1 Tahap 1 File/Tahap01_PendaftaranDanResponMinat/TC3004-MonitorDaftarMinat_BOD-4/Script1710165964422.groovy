...
def closed = WebUI.verifyTextNotPresent('Proses Pengadaan Tahapan Pendaftaran & Respon Minat sudah habis!', false, FailureHandling.OPTIONAL)

// Ubah Jadwal ke Aanwijzing
if (closed.equals(true)) {
    WebUI.callTestCase(findTestCase('Transaction-Management/Penunjukan_langsung/1 Tahap 1 File/Paket02_UbahJadwal_woLogin'), 
        [('tahap') : 2], FailureHandling.STOP_ON_FAILURE)

    WebUI.delay(10) //WebUI.verifyTextPresent('Proses Pengadaan Tahapan Pendaftaran & Respon Minat sudah habis!', false)
}

WebUI.verifyTextPresent('Proses Pengadaan Tahapan Pendaftaran & Respon Minat sudah habis!', false, FailureHandling.OPTIONAL)
