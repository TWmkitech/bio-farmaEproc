...
WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap02/text_BuatTopik'))

WebUI.setText(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/Tahap02/text_BuatTopik'), 'Automation Test Topik Aanwijzing')
...
WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Vendor/Tahap02/button_OK'))

WebUI.verifyElementPresent(findTestObject('TransactionManagement/Penunjukan_Langsung/Vendor/Tahap02/verify_PopupBerhasil'), 
    5)
