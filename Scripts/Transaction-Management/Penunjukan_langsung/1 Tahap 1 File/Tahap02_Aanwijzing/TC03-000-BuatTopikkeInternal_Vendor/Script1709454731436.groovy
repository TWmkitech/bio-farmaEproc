...
WebUI.scrollToElement(findTestObject('TransactionManagement/Penunjukan_Langsung/Vendor/Tahap02/text_BuatTopik'), 0)

String teks = 'Topik Aanwijzing dari Vendor'
...
WebUI.verifyElementText(findTestObject('TransactionManagement/Penunjukan_Langsung/Vendor/Tahap02/verify_TextTopik', [('list') : topik]), 
    teks)
