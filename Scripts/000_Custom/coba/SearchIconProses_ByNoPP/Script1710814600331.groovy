...
String ExpectedValue = "PP/JPROC/2024/000075";
...
Loop: for (int row = 0; row < rows_count; row++) {
    ...
    for (int column = 0; column < columns_count; column++) {
        ...
        if (celltext == ExpectedValue) {
            ...
            println((('Text present in row number ' + row) + ' is: ') + Columns_row.get(1).getText())

            baris = (row + 1)

            println('________________Baris ' + baris)

            TestObject targetElementz = findTestObject('Object Repository/TransactionManagement/Tender-Seleksi_Terbatas/1 Tahap 2 File/Tahap01_PendaftaranDanResponMinat/Internal/Icon_Proses')

            WebUI.sendKeys(targetElementz, Keys.chord(Keys.ARROW_RIGHT))
			
			WebUI.scrollToPosition(0, 250)
			
            def xpath = ('/html/body/div/div[1]/div[2]/div[3]/div[3]/div/div/div[3]/div/div/div/div[1]/div/div/div/div[2]/div/div/table/tbody/tr[' + 
            baris) + ']/td[6]/span[1]/span/a'
