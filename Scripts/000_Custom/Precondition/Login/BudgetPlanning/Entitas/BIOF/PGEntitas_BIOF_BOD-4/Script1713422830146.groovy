...
WebUI.setText(findTestObject('Object Repository/Login/internal/Field_Email'), '11000387')
...
WebUI.verifyElementText(findTestObject('Login/internal/Verify_Username'), 'Afifah Nadhirah')
