...
WebUI.setText(findTestObject('Object Repository/Login/internal/Field_Email'), '12000449')
...
WebUI.verifyElementText(findTestObject('Login/internal/Verify_Username'), 'Putri Janu Ayundhana')
...
WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/General/select_Holding_BOD-4'))
