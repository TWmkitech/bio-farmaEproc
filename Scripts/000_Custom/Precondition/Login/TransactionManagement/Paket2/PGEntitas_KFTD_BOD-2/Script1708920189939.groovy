...
WebUI.setText(findTestObject('Object Repository/Login/internal/Field_Email'), '15000050')
...
WebUI.verifyElementText(findTestObject('Login/internal/Verify_Username'), 'Panji Alam')
