...
WebUI.setText(findTestObject('Object Repository/Login/internal/Field_Email'), '12000058')
...
WebUI.verifyElementText(findTestObject('Login/internal/Verify_Username'), 'Nurul Fatonah Kurniawati')
...
WebUI.click(findTestObject('TransactionManagement/Penunjukan_Langsung/Internal/General/select_Holding_BOD-1'))
