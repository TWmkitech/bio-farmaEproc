...
WebUI.verifyElementText(findTestObject('Login/internal/Verify_Username'), 'Acep Tantan Hardiana')
...
WebUI.click(findTestObject('TransactionManagement/Global-TestObject/ChangeRoles/Selectbox_ChangeRoles_2'))
