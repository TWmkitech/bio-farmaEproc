...
WebUI.setText(findTestObject('Object Repository/Login/internal/Field_Email'), '21000040')
...
WebUI.verifyElementText(findTestObject('Login/internal/Verify_Username'), 'Beny Alkahf')
