...
WebUI.setText(findTestObject('Object Repository/Login/internal/Field_Email'), '21000120')
...
WebUI.verifyElementText(findTestObject('Login/internal/Verify_Username'), 'Heri Purnomo')
