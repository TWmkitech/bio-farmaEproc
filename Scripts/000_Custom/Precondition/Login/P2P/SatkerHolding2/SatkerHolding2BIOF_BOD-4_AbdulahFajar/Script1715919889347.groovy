...
WebUI.setText(findTestObject('Object Repository/Login/internal/Field_Email'), '11001460')
...
WebUI.waitForElementPresent(findTestObject('P2P/1_PurchaseRequest/0_GlobalTestObject/Satker/Anchor_PurchaseRequest'), 30)
