...
for (int row = 0; row < rows_count; row++) {
	...
	for (int column = 0; column < columns_count; column++) {
		...
		if (celltext == ExpectedValue) {
			...
			def xpath = ('/html/body/div/div[1]/div[2]/div[3]/div[3]/div/div/div[3]/div/div/div/div[1]/div/div/div/div[2]/div/div/table/tbody/tr['+row+']/td[6]/span[1]/a')
			
			WebUI.click(findTestObject('Object Repository/TransactionManagement/Global-TestObject/Try/custom Icon Proses Try', [('baris') : row]))
