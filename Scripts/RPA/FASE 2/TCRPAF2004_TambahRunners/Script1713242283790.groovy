...
WebUI.click(findTestObject('RPA/Runner/Nav_Penjadwal'))

WebUI.click(findTestObject('RPA/Runner/Button_TambahPenjadwal'))

WebUI.setText(findTestObject('RPA/Runner/Field_EkspresiCron'), '*/10 * * * 1')

WebUI.setText(findTestObject('RPA/Runner/Field_NamaPenjadwal'), 'test')

WebUI.setText(findTestObject('RPA/Runner/Field_Keterangan'), 'test')

WebUI.click(findTestObject('RPA/Runner/Checkbox'))

WebUI.click(findTestObject('RPA/Runner/Button_Simpan'))

WebUI.click(findTestObject('RPA/Runner/Button_Ok'))
