...
WebUI.waitForElementPresent(findTestObject('P2P/5_ProductReceipt/Internal/4_Approval/ICON_Review'), 30)

WebUI.sendKeys(findTestObject('P2P/5_ProductReceipt/Internal/4_Approval/ICON_Review'), Keys.chord(Keys.ARROW_RIGHT))

WebUI.click(findTestObject('P2P/5_ProductReceipt/Internal/4_Approval/ICON_Review'))
