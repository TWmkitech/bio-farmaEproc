...
WebUI.callTestCase(findTestCase('000_Custom/Precondition/Login/P2P/OperasionalHolding/OperasionalHolding_BioFarma_BOD-2'), 
...
WebUI.waitForElementPresent(findTestObject('P2P/5_ProductReceipt/Internal/5_Pengujian/ICON_ReviewUji'), 30)

WebUI.sendKeys(findTestObject('P2P/5_ProductReceipt/Internal/5_Pengujian/ICON_ReviewUji'), Keys.chord(Keys.ARROW_RIGHT))

WebUI.click(findTestObject('P2P/5_ProductReceipt/Internal/5_Pengujian/ICON_ReviewUji'))
