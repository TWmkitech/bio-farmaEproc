...
WebUI.waitForElementPresent(findTestObject('User-Management/Tenant/Tambah_Tenant/Div_DataEntitas'), 0)

WebUI.click(findTestObject('User-Management/Tenant/Tambah_Tenant/Div_DataEntitas'))
...
WebUI.click(findTestObject('User-Management/Tenant/Tambah_Tenant/Button_OK'))
