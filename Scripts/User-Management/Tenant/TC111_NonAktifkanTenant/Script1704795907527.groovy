...
TestObject targetElement = findTestObject('Object Repository/User-Management/Tenant/NonAktifkan_Tenant/Button_NonAktifkanData')

WebUI.sendKeys(targetElement, Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('User-Management/Tenant/NonAktifkan_Tenant/Button_NonAktifkanData'), 0)

WebUI.click(findTestObject('User-Management/Tenant/NonAktifkan_Tenant/Button_NonAktifkanData'))

WebUI.waitForElementPresent(findTestObject('User-Management/Tenant/NonAktifkan_Tenant/Button_OK'), 0)

WebUI.click(findTestObject('User-Management/Tenant/NonAktifkan_Tenant/Button_OK'))
