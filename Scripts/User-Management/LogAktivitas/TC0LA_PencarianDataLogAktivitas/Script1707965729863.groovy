...
WebUI.getText(findTestObject('User-Management/LogAktivitas/Record1'))

/*WebUI.verifyMatch(WebUI.getText(findTestObject('User-Management/LogAktivitas/Record1'), 5), ('(?i).*' + search) + '.*', 
    true)*/

WebUI.verifyElementText(findTestObject('User-Management/LogAktivitas/Record1'), 'Bima Gustitresna')
