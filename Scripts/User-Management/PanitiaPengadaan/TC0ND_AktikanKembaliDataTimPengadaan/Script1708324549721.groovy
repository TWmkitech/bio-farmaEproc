...
WebUI.click(findTestObject('User-Management/PanitiaPengadaan/AktifkanKembaliDataTimPengadaan/Menu_NonAktif'))

TestObject targetElement = findTestObject('Object Repository/User-Management/PanitiaPengadaan/AktifkanKembaliDataTimPengadaan/Icon_AktifkanData')
