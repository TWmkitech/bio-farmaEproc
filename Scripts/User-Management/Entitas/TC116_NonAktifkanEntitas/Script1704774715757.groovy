...
TestObject targetElement = findTestObject('Object Repository/User-Management/Entitas/NonAktifkanEntitas/Button_NonAktifkan')

WebUI.sendKeys(targetElement, Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('User-Management/Entitas/NonAktifkanEntitas/Button_NonAktifkan'), 0)

WebUI.click(findTestObject('User-Management/Entitas/NonAktifkanEntitas/Button_NonAktifkan'))

WebUI.waitForElementPresent(findTestObject('User-Management/Entitas/NonAktifkanEntitas/Button_OK'), 0)

WebUI.click(findTestObject('User-Management/Entitas/NonAktifkanEntitas/Button_OK'))
