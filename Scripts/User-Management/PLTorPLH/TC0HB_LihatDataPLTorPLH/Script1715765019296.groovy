...
WebUI.click(findTestObject('User-Management/Global-TestObject/Anchor_PLTorPLH'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('User-Management/PLTorPLH/Button_Detail'), 5)

WebUI.scrollToElement(findTestObject('User-Management/PLTorPLH/Button_Detail'), 5)

WebUI.waitForElementPresent(findTestObject('User-Management/PLTorPLH/Button_Detail'), 5)

WebUI.click(findTestObject('User-Management/PLTorPLH/Button_Detail'))
