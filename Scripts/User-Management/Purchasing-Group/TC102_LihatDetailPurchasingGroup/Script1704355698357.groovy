...
WebUI.waitForElementPresent(findTestObject('User-Management/PurchasingGroup/Detail_PurchasingGroup/Button_Detail'), 0)

WebUI.click(findTestObject('User-Management/PurchasingGroup/Detail_PurchasingGroup/Button_Detail'))
