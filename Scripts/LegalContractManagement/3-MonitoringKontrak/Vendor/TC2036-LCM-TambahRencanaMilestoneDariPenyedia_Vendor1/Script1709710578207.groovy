...
WebUI.scrollToElement(findTestObject('LegalContractManagement/1Tahap2File/3_MonitoringKontrak/Vendor/1_Tambah RencanaMilestone/Text_MonitoringKontrak'), 
    5)

WebUI.click(findTestObject('LegalContractManagement/1Tahap2File/3_MonitoringKontrak/Vendor/1_Tambah RencanaMilestone/IP_Icon_Tambah'))

WebUI.setText(findTestObject('LegalContractManagement/1Tahap2File/3_MonitoringKontrak/Vendor/1_Tambah RencanaMilestone/Tbox_Milestone'), 
    'Test Milestone')

WebUI.setText(findTestObject('LegalContractManagement/1Tahap2File/3_MonitoringKontrak/Vendor/1_Tambah RencanaMilestone/Tbox_Bobot'), 
    '100')

WebUI.click(findTestObject('LegalContractManagement/1Tahap2File/3_MonitoringKontrak/Vendor/1_Tambah RencanaMilestone/Date_Deadline'))

WebUI.click(findTestObject('LegalContractManagement/1Tahap2File/3_MonitoringKontrak/Vendor/1_Tambah RencanaMilestone/Date_Deadline_11'))
