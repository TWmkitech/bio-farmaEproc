...
WebUI.waitForElementPresent(findTestObject('Data-Integrasi/LihatDetail_PurchaseRequest/Button_Detail'), 0)

WebUI.click(findTestObject('Data-Integrasi/LihatDetail_PurchaseRequest/Button_Detail'))

WebUI.waitForElementPresent(findTestObject('Data-Integrasi/LihatDetail_PurchaseRequest/NavLink_PurchaseRequest'), 0)

WebUI.click(findTestObject('Data-Integrasi/LihatDetail_PurchaseRequest/NavLink_PurchaseRequest'))
...
WebUI.waitForElementPresent(findTestObject('Data-Integrasi/LihatDetail_PurchaseRequest/NavLink_LogFailed'), 0)

WebUI.click(findTestObject('Data-Integrasi/LihatDetail_PurchaseRequest/NavLink_LogFailed'))
