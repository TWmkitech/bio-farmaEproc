...
WebUI.waitForElementPresent(findTestObject('Data-Integrasi/Global-TestObject/Anchor_Origin'), 0)

WebUI.click(findTestObject('Data-Integrasi/Global-TestObject/Anchor_Origin'))

WebUI.waitForElementPresent(findTestObject('Data-Integrasi/UploadDataIntegrasiOrigin/Button_Unggah'), 0)

WebUI.delay(10)

WebUI.click(findTestObject('Data-Integrasi/UploadDataIntegrasiOrigin/Button_Unggah'))

WebUI.delay(10)

WebUI.waitForElementClickable(findTestObject('Data-Integrasi/UploadDataIntegrasiOrigin/Button_ChooseFile'), 0)

// Ambil elemen field "Choose File"
TestObject uploadField = findTestObject('Data-Integrasi/UploadDataIntegrasiOrigin/Button_ChooseFile')

// Mendapatkan direktori proyek
def projectDir = Config.getProjectDir()

// Membentuk path lengkap file yang ingin diunggah
def filePath = projectDir + '/Document/origin_DataIntegrasi.xlsx'

WebUI.uploadFile(uploadField, filePath)

WebUI.delay(10)

WebUI.waitForElementClickable(findTestObject('Data-Integrasi/UploadDataIntegrasiOrigin/Button_Proses'), 0)

WebUI.click(findTestObject('Data-Integrasi/UploadDataIntegrasiOrigin/Button_Proses'))

WebUI.waitForElementClickable(findTestObject('Data-Integrasi/UploadDataIntegrasiOrigin/Button_OK'), 0)

WebUI.click(findTestObject('Data-Integrasi/UploadDataIntegrasiOrigin/Button_OK'))
