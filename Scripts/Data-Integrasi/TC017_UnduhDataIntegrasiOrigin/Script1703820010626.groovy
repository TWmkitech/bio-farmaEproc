...
TestObject targetElement = findTestObject('Object Repository/Data-Integrasi/UnduhDataIntegrasi_Origin/Button_Download')

WebUI.sendKeys(targetElement, Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('Data-Integrasi/UnduhDataIntegrasi_Origin/Button_Download'), 0)

WebUI.click(findTestObject('Data-Integrasi/UnduhDataIntegrasi_Origin/Button_Download'))
