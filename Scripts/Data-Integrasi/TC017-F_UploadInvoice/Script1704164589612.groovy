...
WebUI.waitForElementPresent(findTestObject('Data-Integrasi/Upload_Invoice/Button_Unggah'), 0)

WebUI.click(findTestObject('Data-Integrasi/Upload_Invoice/Button_Unggah'))

WebUI.delay(10)

WebUI.waitForElementClickable(findTestObject('Data-Integrasi/Upload_Invoice/Button_ChooseFile'), 0)

// Ambil elemen field "Choose File"
TestObject uploadField = findTestObject('Data-Integrasi/Upload_Invoice/Button_ChooseFile')
...
WebUI.waitForElementClickable(findTestObject('Data-Integrasi/Upload_Invoice/Button_Proses'), 0)

WebUI.click(findTestObject('Data-Integrasi/Upload_Invoice/Button_Proses'))

WebUI.waitForElementClickable(findTestObject('Data-Integrasi/Upload_Invoice/Button_OK'), 0)

WebUI.click(findTestObject('Data-Integrasi/Upload_Invoice/Button_OK'))
