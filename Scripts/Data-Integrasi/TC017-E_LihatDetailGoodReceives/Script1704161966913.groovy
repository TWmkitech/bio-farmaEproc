...
TestObject targetElement = findTestObject('Object Repository/Data-Integrasi/LihatDetail_GoodReceives/Button_Detail')

WebUI.sendKeys(targetElement, Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('Data-Integrasi/LihatDetail_GoodReceives/Button_Detail'), 0)

WebUI.click(findTestObject('Data-Integrasi/LihatDetail_GoodReceives/Button_Detail'))

WebUI.waitForElementPresent(findTestObject('Data-Integrasi/LihatDetail_GoodReceives/NavLink_GoodReceives'), 0)

WebUI.click(findTestObject('Data-Integrasi/LihatDetail_GoodReceives/NavLink_GoodReceives'))
...
WebUI.waitForElementPresent(findTestObject('Data-Integrasi/LihatDetail_GoodReceives/NavLink_LogFailed'), 0)

WebUI.click(findTestObject('Data-Integrasi/LihatDetail_GoodReceives/NavLink_LogFailed'))
