...
TestObject targetElement = findTestObject('Object Repository/Data-Integrasi/LihatDetail_MataUang/Button_Detail')

WebUI.sendKeys(targetElement, Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('Data-Integrasi/LihatDetail_MataUang/Button_Detail'), 0)

WebUI.click(findTestObject('Data-Integrasi/LihatDetail_MataUang/Button_Detail'))

WebUI.waitForElementPresent(findTestObject('Data-Integrasi/LihatDetail_MataUang/NavLink_Currency'), 0)

WebUI.click(findTestObject('Data-Integrasi/LihatDetail_MataUang/NavLink_Currency'))
...
WebUI.waitForElementPresent(findTestObject('Data-Integrasi/LihatDetail_MataUang/NavLink_LogFailed'), 0)

WebUI.click(findTestObject('Data-Integrasi/LihatDetail_MataUang/NavLink_LogFailed'))
