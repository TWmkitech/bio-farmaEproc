...
TestObject targetElement = findTestObject('Object Repository/Data-Integrasi/LihatDetail_Invoice/Button_Detail')

WebUI.sendKeys(targetElement, Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('Data-Integrasi/LihatDetail_Invoice/Button_Detail'), 0)

WebUI.click(findTestObject('Data-Integrasi/LihatDetail_Invoice/Button_Detail'))

WebUI.waitForElementPresent(findTestObject('Data-Integrasi/LihatDetail_Invoice/NavLink_Invoice'), 0)

WebUI.click(findTestObject('Data-Integrasi/LihatDetail_Invoice/NavLink_Invoice'))
...
WebUI.waitForElementPresent(findTestObject('Data-Integrasi/LihatDetail_Invoice/NavLink_LogFailed'), 0)

WebUI.click(findTestObject('Data-Integrasi/LihatDetail_Invoice/NavLink_LogFailed'))
