...
WebUI.waitForElementPresent(findTestObject('Data-Integrasi/Upload_PurchaseRequest/Button_Unggah'), 0)

WebUI.click(findTestObject('Data-Integrasi/Upload_PurchaseRequest/Button_Unggah'))

WebUI.delay(10)

WebUI.waitForElementClickable(findTestObject('Data-Integrasi/Upload_PurchaseRequest/Button_ChooseFile'), 0)

// Ambil elemen field "Choose File"
TestObject uploadField = findTestObject('Data-Integrasi/Upload_PurchaseRequest/Button_ChooseFile')

// Mendapatkan direktori proyek
def projectDir = Config.getProjectDir()

// Membentuk path lengkap file yang ingin diunggah
def filePath = projectDir + '/Document/purchaseRequest_DataIntegrasi.xlsx'

WebUI.uploadFile(uploadField, filePath)

WebUI.delay(10)

WebUI.waitForElementClickable(findTestObject('Data-Integrasi/Upload_PurchaseRequest/Button_Proses'), 0)

WebUI.click(findTestObject('Data-Integrasi/Upload_PurchaseRequest/Button_Proses'))

WebUI.waitForElementClickable(findTestObject('Data-Integrasi/Upload_PurchaseRequest/Button_OK'), 0)

WebUI.click(findTestObject('Data-Integrasi/Upload_PurchaseRequest/Button_OK'))
