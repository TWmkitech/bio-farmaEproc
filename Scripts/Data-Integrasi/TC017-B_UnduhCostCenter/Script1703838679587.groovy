...
TestObject targetElement = findTestObject('Object Repository/Data-Integrasi/Unduh_CostCenter/Button_Download')

WebUI.sendKeys(targetElement, Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('Data-Integrasi/Unduh_CostCenter/Button_Download'), 0)

WebUI.click(findTestObject('Data-Integrasi/Unduh_CostCenter/Button_Download'))
