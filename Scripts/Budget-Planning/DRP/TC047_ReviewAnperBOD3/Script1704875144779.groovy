...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ReviewAnperBOD3/Button_Review'), 0)
...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ReviewAnperBOD3/Checkbox_Persetujuan'), 0)

WebUI.click(findTestObject('Budget-Planning/DRP/ReviewAnperBOD3/Checkbox_Persetujuan'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ReviewAnperBOD3/Button_Kirim'), 0)

WebUI.click(findTestObject('Budget-Planning/DRP/ReviewAnperBOD3/Button_Kirim'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ReviewAnperBOD3/Button_OK'), 0)
