...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ApprovalAnperBOD1/Button_Approve'), 0)
...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ApprovalAnperBOD1/Checkbox_Persetujuan'), 0)

WebUI.click(findTestObject('Budget-Planning/DRP/ApprovalAnperBOD1/Checkbox_Persetujuan'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ApprovalAnperBOD1/Button_Kirim'), 0)

WebUI.click(findTestObject('Budget-Planning/DRP/ApprovalAnperBOD1/Button_Kirim'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ApprovalAnperBOD1/Button_OK'), 0)
