...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ApprovalHolding/Button_Approval'), 0)

WebUI.click(findTestObject('Budget-Planning/DRP/ApprovalHolding/Button_Approval'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ApprovalHolding/Button_Kirim'), 0)

WebUI.click(findTestObject('Budget-Planning/DRP/ApprovalHolding/Button_Kirim'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ApprovalHolding/Button_OK'), 0)
