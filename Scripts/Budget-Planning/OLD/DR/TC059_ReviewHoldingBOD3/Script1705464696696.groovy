...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Button_Review'), 0)

WebUI.click(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Button_Review'))

WebUI.delay(5)

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Button_Persetujuan'), 0)

WebUI.click(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Button_Persetujuan'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Checkbox_Setuju'), 0)

WebUI.click(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Checkbox_Setuju'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Button_KirimPersetujuan'), 0)

WebUI.click(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Button_KirimPersetujuan'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Button_OKpersetujuan'), 0)
...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Field_LanjutRFI'), 0)

WebUI.click(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Field_LanjutRFI'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Div_No'), 0)

WebUI.click(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Div_No'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Button_Simpan'), 0)

WebUI.click(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Button_Simpan'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewHoldingBOD3/Button_OK'), 0)
