...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/KonfigurasiPengadaan/KirimUndangan/Button_KirimUndangan'), 0)

WebUI.click(findTestObject('Budget-Planning/KonfigurasiPengadaan/KirimUndangan/Button_KirimUndangan'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/KonfigurasiPengadaan/KirimUndangan/Button_OK'), 0)
