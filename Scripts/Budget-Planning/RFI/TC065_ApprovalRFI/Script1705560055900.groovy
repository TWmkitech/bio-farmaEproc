...
TestObject targetElement = findTestObject('Object Repository/Budget-Planning/RFI/ApprovalRFI/Button_Approval')

WebUI.sendKeys(targetElement, Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/RFI/ApprovalRFI/Button_Approval'), 0)

WebUI.click(findTestObject('Budget-Planning/RFI/ApprovalRFI/Button_Approval'))
...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/RFI/ApprovalRFI/Checkbox_Persetujuan'), 0)

WebUI.click(findTestObject('Budget-Planning/RFI/ApprovalRFI/Checkbox_Persetujuan'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/RFI/ApprovalRFI/Button_Simpan'), 0)

WebUI.click(findTestObject('Budget-Planning/RFI/ApprovalRFI/Button_Simpan'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/RFI/ApprovalRFI/Button_OK'), 0)
