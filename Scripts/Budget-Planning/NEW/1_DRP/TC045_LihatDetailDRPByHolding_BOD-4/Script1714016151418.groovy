...
WebUI.sendKeys(findTestObject('Budget-Planning/DRP/DetailDRP/Button_Detail'), Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/DetailDRP/Button_Detail'), 20)

WebUI.click(findTestObject('Budget-Planning/DRP/DetailDRP/Button_Detail'))
