...
WebUI.setText(findTestObject('Budget-Planning/DRP/ReviewHolding/TAREA_Catatan'), 'Harga terlalu mahal')
...
WebUI.click(findTestObject('Budget-Planning/DRP/ReviewHolding/ICON_Detail'))
