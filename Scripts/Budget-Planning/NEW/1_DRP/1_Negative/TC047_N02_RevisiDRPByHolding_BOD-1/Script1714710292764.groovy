...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ReviewHolding/RBUTTON_Revisi'), 20)

WebUI.click(findTestObject('Budget-Planning/DRP/ReviewHolding/RBUTTON_Revisi'))

WebUI.clearText(findTestObject('Budget-Planning/DRP/ReviewHolding/TAREA_Catatan'))

WebUI.setText(findTestObject('Budget-Planning/DRP/ReviewHolding/TAREA_Catatan'), 'Revisi: Tambah kuantitas')

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ReviewHolding/Button_Kirim'), 20)

WebUI.click(findTestObject('Budget-Planning/DRP/ReviewHolding/Button_Kirim'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DRP/ReviewHolding/Button_OK'), 20)
