...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/RFI/UbahJadwal/Date_2PenjelasanRFI_WaktuSelesai'), 20)

WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/Date_2PenjelasanRFI_WaktuSelesai'))

WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/SDate_2PenjelasanRFI_WaktuSelesai_2'))
...
WebUI.clearText(findTestObject('Budget-Planning/RFI/UbahJadwal/Hour_2PenjelasanRFI_WaktuSelesai'))

WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/Hour_2PenjelasanRFI_WaktuSelesai'), hour)
...
WebUI.clearText(findTestObject('Budget-Planning/RFI/UbahJadwal/Minute_2PenjelasanRFI_WaktuSelesai'))

WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/Minute_2PenjelasanRFI_WaktuSelesai'), strminute)

String get = WebUI.getText(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_2PenjelasanRFI_WaktuSelesai'))

if (get != ampm) {
    WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_2PenjelasanRFI_WaktuSelesai'))

    WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_2PenjelasanRFI_WaktuSelesai'), Keys.chord(Keys.ENTER))
} else {
    WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_2PenjelasanRFI_WaktuSelesai'), Keys.chord(Keys.ENTER))
}
