...
WebUI.setText(findTestObject('Budget-Planning/RFI/Aanwijzing/TAREA_BuatPertanyaan'), 'Dengan ini apakah setuju?')

TestObject uploadField = findTestObject('Budget-Planning/RFI/Aanwijzing/UPLOAD_BuatPertanyaan')
...
WebUI.click(findTestObject('Budget-Planning/RFI/Aanwijzing/BUTTON_Kirim'))
