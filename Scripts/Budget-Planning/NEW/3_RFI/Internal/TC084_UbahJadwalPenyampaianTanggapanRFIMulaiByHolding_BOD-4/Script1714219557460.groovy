...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/RFI/UbahJadwal/Date_3PenyampaianTanggapan_WaktuMulai'), 20)

WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/Date_3PenyampaianTanggapan_WaktuMulai'))

WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/SDate_3PenyampaianTanggapan_WaktuMulai_2'))
...
WebUI.clearText(findTestObject('Budget-Planning/RFI/UbahJadwal/Hour_3PenyampaianTanggapan_WaktuMulai'))

WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/Hour_3PenyampaianTanggapan_WaktuMulai'), hour)
...
WebUI.clearText(findTestObject('Budget-Planning/RFI/UbahJadwal/Minute_3PenyampaianTanggapan_WaktuMulai'))

WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/Minute_3PenyampaianTanggapan_WaktuMulai'), strminute)

String get = WebUI.getText(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_3PenyampaianTanggapan_WaktuMulai'))

if (get != ampm) {
    WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_3PenyampaianTanggapan_WaktuMulai'))

    WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_3PenyampaianTanggapan_WaktuMulai'), Keys.chord(Keys.ENTER))
} else {
    WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_3PenyampaianTanggapan_WaktuMulai'), Keys.chord(Keys.ENTER))
}
