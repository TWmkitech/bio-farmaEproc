...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/RFI/UbahJadwal/Date_4PembukaanTanggapanRFI_WaktuMulai'), 20)

WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/Date_4PembukaanTanggapanRFI_WaktuMulai'))

WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/SDate_4PembukaanTanggapanRFI_WaktuMulai_2'))
...
WebUI.clearText(findTestObject('Budget-Planning/RFI/UbahJadwal/Hour_4PembukaanTanggapanRFI_WaktuMulai'))

WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/Hour_4PembukaanTanggapanRFI_WaktuMulai'), hour)
...
WebUI.clearText(findTestObject('Budget-Planning/RFI/UbahJadwal/Minute_4PembukaanTanggapanRFI_WaktuMulai'))

WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/Minute_4PembukaanTanggapanRFI_WaktuMulai'), strminute)

String get = WebUI.getText(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_4PembukaanTanggapanRFI_WaktuMulai'))

if (get != ampm) {
    WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_4PembukaanTanggapanRFI_WaktuMulai'))

    WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_4PembukaanTanggapanRFI_WaktuMulai'), Keys.chord(Keys.ENTER))
} else {
    WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_4PembukaanTanggapanRFI_WaktuMulai'), Keys.chord(Keys.ENTER))
}
