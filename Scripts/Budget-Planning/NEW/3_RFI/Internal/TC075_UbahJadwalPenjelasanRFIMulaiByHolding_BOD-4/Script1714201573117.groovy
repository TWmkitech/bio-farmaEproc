...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/RFI/UbahJadwal/Date_2PenjelasanRFI_WaktuMulai'), 20)

WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/Date_2PenjelasanRFI_WaktuMulai'))

WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/SDate_2PenjelasanRFI_WaktuMulai_2'))
...
WebUI.clearText(findTestObject('Budget-Planning/RFI/UbahJadwal/Hour_2PenjelasanRFI_WaktuMulai'))

WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/Hour_2PenjelasanRFI_WaktuMulai'), hour)
...
WebUI.clearText(findTestObject('Budget-Planning/RFI/UbahJadwal/Minute_2PenjelasanRFI_WaktuMulai'))

WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/Minute_2PenjelasanRFI_WaktuMulai'), strminute)

String get = WebUI.getText(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_2PenjelasanRFI_WaktuMulai'))

if (get != ampm) {
    WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_2PenjelasanRFI_WaktuMulai'))

    WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_2PenjelasanRFI_WaktuMulai'), Keys.chord(Keys.ENTER))
} else {
    WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_2PenjelasanRFI_WaktuMulai'), Keys.chord(Keys.ENTER))
}
