...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/RFI/UbahJadwal/Date_3PenyampaianTanggapan_WaktuSelesai'), 20)

WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/Date_3PenyampaianTanggapan_WaktuSelesai'))

WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/SDate_3PenyampaianTanggapan_WaktuSelesai_2'))
...
WebUI.clearText(findTestObject('Budget-Planning/RFI/UbahJadwal/Hour_3PenyampaianTanggapan_WaktuSelesai'))

WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/Hour_3PenyampaianTanggapan_WaktuSelesai'), hour)
...
WebUI.clearText(findTestObject('Budget-Planning/RFI/UbahJadwal/Minute_3PenyampaianTanggapan_WaktuSelesai'))

WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/Minute_3PenyampaianTanggapan_WaktuSelesai'), strminute)

String get = WebUI.getText(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_3PenyampaianTanggapan_WaktuSelesai'))

if (get != ampm) {
    WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_3PenyampaianTanggapan_WaktuSelesai'))

    WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_3PenyampaianTanggapan_WaktuSelesai'), Keys.chord(
            Keys.ENTER))
} else {
    WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_3PenyampaianTanggapan_WaktuSelesai'), Keys.chord(
            Keys.ENTER))
