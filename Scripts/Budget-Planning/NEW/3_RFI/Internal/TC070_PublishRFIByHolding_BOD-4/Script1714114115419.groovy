...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/RFI/PublishRFI/Button_Publish'), 20)

WebUI.click(findTestObject('Budget-Planning/RFI/PublishRFI/Button_Publish'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/RFI/PublishRFI/Button_Submit'), 20)
