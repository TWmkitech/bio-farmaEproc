...
WebUI.sendKeys(findTestObject('Budget-Planning/RFI/ReviewRFI/Icon_Detail'), Keys.chord(Keys.ARROW_RIGHT))

WebUI.click(findTestObject('Budget-Planning/RFI/ReviewRFI/Icon_Detail'))
