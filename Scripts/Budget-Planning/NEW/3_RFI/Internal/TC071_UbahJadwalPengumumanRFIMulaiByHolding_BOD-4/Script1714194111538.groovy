...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/RFI/UbahJadwal/Date_1PengumumanRFI_WaktuMulai'), 20)

WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/Date_1PengumumanRFI_WaktuMulai'))

WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/SDate_1PengumumanRFI_WaktuMulai_2'))
...
WebUI.clearText(findTestObject('Budget-Planning/RFI/UbahJadwal/Hour_1PengumumanRFI_WaktuMulai'))

WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/Hour_1PengumumanRFI_WaktuMulai'), hour)
...
WebUI.clearText(findTestObject('Budget-Planning/RFI/UbahJadwal/Minute_1PengumumanRFI_WaktuMulai'))

WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/Minute_1PengumumanRFI_WaktuMulai'), strminute)

String get = WebUI.getText(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_1PengumumanRFI_WaktuMulai'))

if (get != ampm) {
    WebUI.click(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_1PengumumanRFI_WaktuMulai'))

    WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_1PengumumanRFI_WaktuMulai'), Keys.chord(Keys.ENTER))
} else {
    WebUI.sendKeys(findTestObject('Budget-Planning/RFI/UbahJadwal/AMPM_1PengumumanRFI_WaktuMulai'), Keys.chord(Keys.ENTER))
}
