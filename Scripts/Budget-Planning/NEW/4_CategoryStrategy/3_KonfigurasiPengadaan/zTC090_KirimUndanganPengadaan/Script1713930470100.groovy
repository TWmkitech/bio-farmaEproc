...
TestObject targetElement = findTestObject('Object Repository/Budget-Planning/KonfigurasiPengadaan/KirimUndangan/Button_KirimUndangan')

WebUI.sendKeys(targetElement, Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/KonfigurasiPengadaan/KirimUndangan/Button_KirimUndangan'), 20)

WebUI.click(findTestObject('Budget-Planning/KonfigurasiPengadaan/KirimUndangan/Button_KirimUndangan'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/KonfigurasiPengadaan/KirimUndangan/Button_OK'), 20)

WebUI.click(findTestObject('Budget-Planning/KonfigurasiPengadaan/KirimUndangan/Button_OK'))
