...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/KonfigurasiPengadaan/ReviewKonfigurasi/Button_Review'), 20)
...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/KonfigurasiPengadaan/ReviewKonfigurasi/Div_2Tahap2File'), 20)
...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/KonfigurasiPengadaan/ReviewKonfigurasi/Button_Simpan'), 20)

WebUI.click(findTestObject('Budget-Planning/KonfigurasiPengadaan/ReviewKonfigurasi/Button_Simpan'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/KonfigurasiPengadaan/ReviewKonfigurasi/Button_OK'), 20)
