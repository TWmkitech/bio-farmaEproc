...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/PemaketanPekerjaan/01_New/Tahap 3/BUTTON_SimpanPemaketanPekerjaan'), 
    20)

WebUI.click(findTestObject('Budget-Planning/PemaketanPekerjaan/01_New/Tahap 3/BUTTON_SimpanPemaketanPekerjaan'))
