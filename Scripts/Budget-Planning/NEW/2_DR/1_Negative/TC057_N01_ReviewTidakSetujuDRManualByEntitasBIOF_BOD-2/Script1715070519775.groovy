...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewAnperBOD2/RBUTTON_TidakSetuju'), 20)

WebUI.click(findTestObject('Budget-Planning/DR/ReviewAnperBOD2/RBUTTON_TidakSetuju'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewAnperBOD2/TAREA_Catatan'), 20)

WebUI.setText(findTestObject('Budget-Planning/DR/ReviewAnperBOD2/TAREA_Catatan'), 'Pembuatan DR tidak disetujui oleh Entitas BOD-2')
...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewAnperBOD2/BUTTON_Kembali'), 20)

WebUI.scrollToElement(findTestObject('Budget-Planning/DR/ReviewAnperBOD2/BUTTON_Kembali'), 20)
