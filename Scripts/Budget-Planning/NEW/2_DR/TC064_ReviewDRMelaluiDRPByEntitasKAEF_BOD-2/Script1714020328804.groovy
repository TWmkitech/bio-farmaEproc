...
WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewAnperDRmelaluiDRP/RBUTTON_Setuju'), 20)

WebUI.click(findTestObject('Budget-Planning/DR/ReviewAnperDRmelaluiDRP/RBUTTON_Setuju'))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/ReviewAnperDRmelaluiDRP/BUTTON_Kirim'), 20)

WebUI.click(findTestObject('Budget-Planning/DR/ReviewAnperDRmelaluiDRP/BUTTON_Kirim'))
