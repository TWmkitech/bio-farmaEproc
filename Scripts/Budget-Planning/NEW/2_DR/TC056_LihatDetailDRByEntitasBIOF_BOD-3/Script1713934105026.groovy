...
WebUI.sendKeys(findTestObject('Budget-Planning/DR/DetailDR/Button_Detail'), Keys.chord(Keys.ARROW_RIGHT))

WebUI.waitForElementPresent(findTestObject('Budget-Planning/DR/DetailDR/Button_Detail'), 20)

WebUI.click(findTestObject('Budget-Planning/DR/DetailDR/Button_Detail'))
