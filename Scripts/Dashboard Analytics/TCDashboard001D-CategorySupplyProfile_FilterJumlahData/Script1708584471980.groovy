...
WebUI.click(findTestObject('Dashboard Analytics/Demand and Spend Profile/Category Supply-Profile/Field_JenisFilter'))

WebUI.click(findTestObject('Dashboard Analytics/Demand and Spend Profile/Category Supply-Profile/Pilih_JenisFilter'))
...
WebUI.click(findTestObject('Dashboard Analytics/Demand and Spend Profile/Category Supply-Profile/Field_Entitas'))

WebUI.click(findTestObject('Dashboard Analytics/Demand and Spend Profile/Category Supply-Profile/Pilih_Entitas'))

WebUI.click(findTestObject('Dashboard Analytics/Demand and Spend Profile/Category Supply-Profile/Field_Tampilkan'))

WebUI.click(findTestObject('Dashboard Analytics/Demand and Spend Profile/Category Supply-Profile/Pilih_Tampilkan'))
