...
WebUI.click(findTestObject('Dashboard Analytics/Demand and Spend Profile/Category Demand-Profile/Field_Entitas'))

WebUI.click(findTestObject('Dashboard Analytics/Demand and Spend Profile/Category Demand-Profile/Pilih_entitas'))
