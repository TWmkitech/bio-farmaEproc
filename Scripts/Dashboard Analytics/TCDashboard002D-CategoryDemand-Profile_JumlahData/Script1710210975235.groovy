...
WebUI.click(findTestObject('Dashboard Analytics/Demand and Spend Profile/Category Demand-Profile/Field_Tampilkan'))

WebUI.click(findTestObject('Dashboard Analytics/Demand and Spend Profile/Category Demand-Profile/Pilih_Tampilkan'))
