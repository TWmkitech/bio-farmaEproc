...
WebUI.setText(findTestObject('Login/vendor/Field_Username'), GlobalVariable.Username)

WebUI.waitForElementPresent(findTestObject('Login/vendor/Field_Password'), 0)

WebUI.setText(findTestObject('Login/vendor/Field_Password'), GlobalVariable.Password)
