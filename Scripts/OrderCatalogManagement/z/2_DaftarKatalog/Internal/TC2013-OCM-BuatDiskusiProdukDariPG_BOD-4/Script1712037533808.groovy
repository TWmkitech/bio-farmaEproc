...
WebUI.click(findTestObject('OrderCatalogManagement/2_DaftarKatalog/Internal/3_DiskusiProduk/1_PG/Button_Hubungi Penjual_1'))
...
WebUI.setText(findTestObject('OrderCatalogManagement/2_DaftarKatalog/Internal/3_DiskusiProduk/TBOX_Topik'), 'Topik Diskusi Dari PG BOD-4')

WebUI.setText(findTestObject('OrderCatalogManagement/2_DaftarKatalog/Internal/3_DiskusiProduk/TBOX_Pesan'), 'Pesan Diskusi Dari PG BOD-4')
