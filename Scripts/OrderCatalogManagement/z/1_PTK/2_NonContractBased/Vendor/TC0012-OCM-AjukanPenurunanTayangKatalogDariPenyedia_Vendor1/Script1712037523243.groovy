...
WebUI.click(findTestObject('OrderCatalogManagement/1_PTK/2_NonContractBased/Vendor/4_ReqPenayanganUpdate/Button_Perubahan Data Katalog'))
...
WebUI.setText(findTestObject('OrderCatalogManagement/1_PTK/1_ContractBased/Vendor/3_ReqPerubahan/TBOX_Catatan'), 'Test Penurunan Daftar Katalog NonContractBased')
...
WebUI.waitForElementPresent(findTestObject('OrderCatalogManagement/1_PTK/2_NonContractBased/Vendor/Verify_Popup_Berhasil'), 
    30)
