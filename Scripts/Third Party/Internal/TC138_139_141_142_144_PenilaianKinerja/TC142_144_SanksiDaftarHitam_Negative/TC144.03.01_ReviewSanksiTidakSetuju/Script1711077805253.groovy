...
WebUI.click(findTestObject('Third Party/Internal/PenilaianKinerja/SanksiDaftarHitam/Radio_TidakSetuju'))

WebUI.setText(findTestObject('Third Party/Internal/PenilaianKinerja/SanksiDaftarHitam/Field_AlasanPenolakan'), 'Ditolak menggunakan automation')
