...
WebUI.click(findTestObject('Third Party/Internal/SupplierRelationship/Edit/Field_TanggalPelaksanaan'))

WebUI.click(findTestObject('Third Party/Internal/SupplierRelationship/Edit/Field_TanggalPelaksanaan_Bulan'))

WebUI.click(findTestObject('Third Party/Internal/SupplierRelationship/Edit/Field_TanggalPelaksanaan_Data'))

// Mendapatkan direktori proyek
def projectDir = Config.getProjectDir()

TestObject uploadField = findTestObject('Third Party/Internal/SupplierRelationship/Edit/Upload_DokumenPendukung')
...
WebUI.click(findTestObject('Third Party/Internal/SupplierRelationship/Edit/Button_KonfirmasiOK'))
