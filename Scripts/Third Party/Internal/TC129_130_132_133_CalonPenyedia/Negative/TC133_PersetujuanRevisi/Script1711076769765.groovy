...
WebUI.setText(findTestObject('Third Party/Internal/Verifikasi/Field_CariData'), 'Automated Test Edit')

WebUI.click(findTestObject('Third Party/Internal/Verifikasi/Anchor_PengajuanVerifikasi'))

WebUI.click(findTestObject('Third Party/Internal/Calon Penyedia/Input_VerifikasiReviewRevisi'))

WebUI.setText(findTestObject('Third Party/Internal/Calon Penyedia/Field_VerifikasiAlasanPenolakan'), 'Direvisi menggunakan automation')
