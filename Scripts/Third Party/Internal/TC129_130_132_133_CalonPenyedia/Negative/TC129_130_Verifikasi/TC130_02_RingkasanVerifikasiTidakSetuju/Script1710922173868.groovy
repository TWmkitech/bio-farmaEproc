...
WebUI.click(findTestObject('Third Party/Internal/Calon Penyedia/Field_VerifikasiTidakSetuju'))

WebUI.setText(findTestObject('Third Party/Internal/Calon Penyedia/Field_VerifikasiKeteranganReject'), 'Ditolak menggunakan automation')
