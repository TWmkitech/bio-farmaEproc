...
not_run: WebUI.callTestCase(findTestCase('Third Party/Internal/TC129_130_132_133_CalonPenyedia/Negative/TC129_130_Verifikasi/TC129_00_VerifikasiLogin'), 
...
Loop: for (int row = 0; row < rows_count; row++) {
    ...
    if (celltext == 'Belum Diverifikasi') {
        if (WebUI.verifyElementPresent(findTestObject('Third Party/Internal/Calon Penyedia/Custom_Button_TidakSetujuPemegangSaham', 
                [('indexpos') : row + 1]), 5, FailureHandling.OPTIONAL)) {
            WebUI.click(findTestObject('Third Party/Internal/Calon Penyedia/Custom_Button_TidakSetujuPemegangSaham', [('indexpos') : row + 
                        1]))

            WebUI.setText(findTestObject('Third Party/Internal/Calon Penyedia/Field_PemegangSahamAlasanPenolakan'), 'Ditolak menggunakan Automation')

            WebUI.click(findTestObject('Third Party/Internal/Calon Penyedia/Button_PemegangSahamTidakSetuju (1)'))
