...
WebUI.click(findTestObject('Third Party/Internal/SurveiKepuasanPenyedia/Anchor_MonitoringSurveiKepuasan'))

WebUI.click(findTestObject('Third Party/Internal/SurveiKepuasanPenyedia/MonitoringSurveiKepuasan/Button_Detail'))
