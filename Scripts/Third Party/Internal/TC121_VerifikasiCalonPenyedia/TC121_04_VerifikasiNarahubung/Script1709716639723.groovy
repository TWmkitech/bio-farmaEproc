...
Loop: for (int row = 0; row < rows_count; row++) {
    ...
    if (celltext == 'Belum Diverifikasi') {
        ...
        if (WebUI.verifyElementPresent(findTestObject('Third Party/Internal/Verifikasi/Custom_Button_VerifikasiNarahubung', [('indexpos') : row + 1]), 
            5, FailureHandling.OPTIONAL)) {
            WebUI.click(findTestObject('Third Party/Internal/Verifikasi/Custom_Button_VerifikasiNarahubung', [('indexpos') : row + 1]))
        }
