...
WebUI.waitForElementPresent(findTestObject('Third Party/Vendor/Data Profile/BuktiKeagenan/Anchor_BuktiKeagenan'), 5)

WebUI.click(findTestObject('Third Party/Vendor/Data Profile/BuktiKeagenan/Anchor_BuktiKeagenan'))

WebUI.click(findTestObject('Third Party/Vendor/Data Profile/BuktiKeagenan/Button_EditData'))
...
WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/BuktiKeagenan/Field_NamaPrincipal'), 'Mr. Arnold Edit')
...
WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/BuktiKeagenan/Field_Keterangan'), 'Diubah menggunakan automation')
