...
WebUI.waitForElementPresent(findTestObject('Third Party/Vendor/Data Profile/DokumenLainnya/Anchor_DokumenLainnya'), 5)

WebUI.click(findTestObject('Third Party/Vendor/Data Profile/DokumenLainnya/Anchor_DokumenLainnya'))

WebUI.click(findTestObject('Third Party/Vendor/Data Profile/DokumenLainnya/Button_EditData'))

WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/DokumenLainnya/Field_Nama'), 'Dokumen Pengajuan Edit')
