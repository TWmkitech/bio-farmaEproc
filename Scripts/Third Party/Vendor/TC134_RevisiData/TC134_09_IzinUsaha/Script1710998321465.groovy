...
WebUI.waitForElementPresent(findTestObject('Third Party/Vendor/Data Profile/IzinUsaha/Anchor_Izin Usaha'), 5)

WebUI.click(findTestObject('Third Party/Vendor/Data Profile/IzinUsaha/Anchor_Izin Usaha'))

WebUI.click(findTestObject('Third Party/Vendor/Data Profile/IzinUsaha/Button_EditData'))
...
WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/IzinUsaha/Field_InstansiPenerbit'), 'Lembaga OSS Edit')
...
WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/IzinUsaha/Field_Keterangan'), 'Diubah menggunakan automation')
