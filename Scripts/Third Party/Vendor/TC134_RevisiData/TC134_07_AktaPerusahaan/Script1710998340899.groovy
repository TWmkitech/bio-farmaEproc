...
WebUI.waitForElementPresent(findTestObject('Third Party/Vendor/Data Profile/AktaPerusahaan/Anchor_AktaPerusahaan'), 5)

WebUI.click(findTestObject('Third Party/Vendor/Data Profile/AktaPerusahaan/Anchor_AktaPerusahaan'))

WebUI.click(findTestObject('Third Party/Vendor/Data Profile/AktaPerusahaan/Button_EditData'))
...
WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/AktaPerusahaan/Field_Nama'), 'Automated Test Edit')
...
WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/AktaPerusahaan/Field_NamaNotaris'), 'Edit Harianto S.H')
...
def filePathAkta = projectDir + '/Document/DokumenDataTest.pdf'
