...
WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/PengalamanPekerjaan/Field_TanggalPelaksanaanAwal_Tahun'), 
    '2023')
...
WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/PengalamanPekerjaan/Field_TanggalPelaksanaanAkhir_Tahun'), 
    '2023')
...
// Membentuk path lengkap file yang ingin diunggah
def filePath2 = projectDir + '/Document/DokumenDataTest.pdf'
