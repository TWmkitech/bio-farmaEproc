...
WebUI.waitForElementPresent(findTestObject('Third Party/Vendor/Data Profile/Peralatan/Anchor_Peralatan'), 5)

WebUI.enhancedClick(findTestObject('Third Party/Vendor/Data Profile/Peralatan/Anchor_Peralatan'))

WebUI.click(findTestObject('Third Party/Vendor/Data Profile/Peralatan/Button_EditData'))

WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/Peralatan/Field_NamaMerk'), 'EditAutoMerk')
