...
WebUI.waitForElementPresent(findTestObject('Third Party/Vendor/Data Profile/BarangJasaMampuPasok/Anchor_BarangJasaMampuPasok'), 
    5)

WebUI.click(findTestObject('Third Party/Vendor/Data Profile/BarangJasaMampuPasok/Anchor_BarangJasaMampuPasok'))

WebUI.click(findTestObject('Third Party/Vendor/Data Profile/BarangJasaMampuPasok/Button_EditData'))
...
WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/BarangJasaMampuPasok/Field_NamaProduct'), 'Produk Automation Edit')
...
WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/BarangJasaMampuPasok/Field_Spesifikasi'), 'Spesifikasi yang diubah menggunakan automation test')
