...
WebUI.waitForElementPresent(findTestObject('Third Party/Vendor/Data Profile/LaporanPajak/Anchor_LaporanPajak'), 5)

WebUI.click(findTestObject('Third Party/Vendor/Data Profile/LaporanPajak/Anchor_LaporanPajak'))

not_run: WebUI.click(findTestObject('Third Party/Vendor/Data Profile/LaporanPajak/Button_EditData'))
