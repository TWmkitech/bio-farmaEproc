...
WebUI.callTestCase(findTestCase('Third Party/Vendor/TC134_RevisiData/TC134_00'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Third Party/Vendor/Data Profile/DataUmum/Field_Alamat'), 'Jl. Edit Test Alamat No. 123')
...
// Membentuk path lengkap file yang ingin diunggah
def filePathProfil = projectDir + '/Document/DokumenDataTest.pdf'
...
// Membentuk path lengkap file yang ingin diunggah
def filePathDokLain = projectDir + '/Document/DokumenDataTest.pdf'
