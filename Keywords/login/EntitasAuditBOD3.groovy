...
public class EntitasAuditBOD3 {
	public login (String EntitasAuditBOD3, String Pass) {
		...
		WebUI.setText(findTestObject('Object Repository/Login/internal/Field_Email'), GlobalVariable.EntitasAuditBOD3)
