...
public class EntitasAuditBOD2 {
	public login (String EntitasAuditBOD2, String Pass) {
		...
		WebUI.setText(findTestObject('Object Repository/Login/internal/Field_Email'), GlobalVariable.EntitasAuditBOD2)
